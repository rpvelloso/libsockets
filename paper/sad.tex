...
adequada das métricas e \textit{baselines} e/ou \textit{datasets}
...
relevância nesta pesquisa, são menciandos trabalhos de extração estruturada
...
desafios envolvidos na realização desta tarefa como, por exmeplo, identificar as
regiões de dados, identificar os registros, alinhar os campos dos registros,
