...
\textoResumo{ Durante o levantamento do estado da arte a respeito do tema
``extração de dados estruturados da \textit{web}'', foram identificados, entre
os trabalhos mais relevantes, três  grupos  principais  de  abordagens:
...
apenas o calculo da diferença entre valores vizinhos da sequência, conforme
