...
\begin{document}
\title{Exame de Qualificação de Doutorado - Extração de Dados Estruturados}
...
\begin{itemize} 
	...
	\item Utilização de informação sintática (escopo da pesquisa);
	\item Requisitos de escalabilidade (grande volume de dados):
	\begin{itemize}
	  \item nível de supervisão;
	  \item generalidade (muita diversidade);
...
Resultados obtidos com dataset contendo $1466$ registros de $46$
