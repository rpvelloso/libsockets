...
average of 54.41\% of the DOM tree, in linear time, avoiding the processing of
...
%the use of our technique, yielding and average of 93.20\% of noise removed from
%the test web pages.
...
and average of 93.20\% of noise removed from the test web pages.
...
Present'' indicates that the algorithm has worked in 83.33\% of the sites and it
has removed, for this test set, an average of 93.20\% of all noise present in the
data, as shown by the average of column ``Noise rem.". We consider these to be
good results.

The average DOM tree reduction of 54.41\% is an interesting result. First,
...
\ref{table:results}, column ``Content Present'', these two situations account for 16.67\% 
...
For situation described for the site ``g1.com.br'' (that happened for three other
...
\hline
Average/Total &  &  & -54.41\% & 83.33\%&  &  &  &  & 93.20\% \\
  &  &  &  & 16.67\%&  &  &  &  &  \\
\hline
