...
são utilizados os campos de formulários da $web$ oculta para treinar uma árvore
de decisão utilizando algoritmo C4.5 para identificar quais nós da árvore DOM
são ruído e quais são conteúdo relevante na resposta à submissão do formulário.
...
desonerar o custo computacional de procurar por padrões no ruído.
\end{itemize}
