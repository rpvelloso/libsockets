...
Este trabalho também foi publicado no \textit{Journal of Information and Data
Management} no ano de 2013, como artigo completo \cite{TPS2013}, e os
algoritmos descritos neste trabalho foram implementados em linguagem $C++$ e $M$
(MatLab/Octave) e estão disponíveis para acesso.
