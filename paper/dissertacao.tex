...
% parâmetro \folhaaprovacao \paginadedicatoria \paginaagradecimento
% \paginaepigrafe \listadefiguras \listadetabelas \listadeabreviaturas
% \listadesimbolos \sumario
...
como ilustrado na Figura \ref{fig:method}, obtendo-se uma média de 77,03\% de
...
\section{Algoritmo tagPathSequenceFilter()}
...
\section{Algoritmo filterAlphabet()}
...
``Conteúdo principal'' indica que o algoritmo funcionou em 84.21\% dos casos e
removeu, com este conjunto de teste, uma média de 89.02\% de todo o ruído
presente nos dados, como mostra a média da coluna ``Ruído rem.''.

A média de 47.93\% de redução no tamanho da árvore DOM é um resultado
...
obtido para a página do $site$ ``Build'' (\#8). Sem filtrar o ruído, o MDR
...
responsáveis por 15.79\% dos casos, onde o conteúdo principal foi removido
...
cinco casos), quando a região principal é menor que as demais, uma abordagem
semântica também pode ser utilizada para validar se a região encontrada, de
