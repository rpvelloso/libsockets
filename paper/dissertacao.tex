...
\titulo{Um Método Automático para Segmentação e Remoção de Ruído de
...
\citeonline{desc2013} & Árvore DOM & Não & Sim & Não & Sim \\
...
\hline
\citeonline{TPS2013} & TPS & Sim & Não & Não & Sim \\
\end{tabular}
\end{tiny}
\end{table}
...
Utilizando as definições do Capítulo \ref{sec:def} e as hipóteses acima, podemos
...
problema definido no Capítulo \ref{sec:probform}. Quais sejam:
...
realização.
Para obter os resultados apresentados na Seção \ref{sub:res}, o algoritmo
...
discutidos e tratados na Seção \ref{sub:disc}, e, apesar desta redução, as
