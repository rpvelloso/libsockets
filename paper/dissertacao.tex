...
\hline
\citeonline{BlockImp07} & Texto & - & - & - & - \\
\citeonline{Densiometric08} & Texto & - & - & - & - \\
\citeonline{Boilerplate10} & Texto & - & - & - & - \\
\citeonline{CETR10} & Texto & - & - & - & - \\
\citeonline{NonTemplate13} & Texto & - & - & - & - \\
\citeonline{Noisy03} & Árvore DOM & Não & Sim & Não & Não \\
\citeonline{Graph08} & Árvore DOM & Não & Sim & Não & Não \\
\citeonline{Entropy09} & Árvore DOM & Sim & Não & Sim & Sim \\
\citeonline{SiteOriented11} & Árvore DOM & Não & Sim & Não & Não \\
\citeonline{Entropy12} & Árvore DOM & Sim & Não & Sim & Sim \\
\citeonline{Jointop07} & Árvore DOM & Não & Sim & Não & Não \\
\citeonline{vips03} & Rep. visual & Sim & Não & Sim & Sim \\
\citeonline{viper05} & Rep. visual & Sim & Não & Não & Sim \\
\citeonline{vide10} & Rep. visual & Sim & Não & Sim & Sim \\
\hline
\citeonline{TPS2013} & TPS & Sim & Não & Não & Não \\
\end{tabular}
\end{tiny}
\end{table}
...
oito casos, $i.e.$ 17,65\%), quando a região principal é menor que as demais,
uma abordagem semântica também pode ser utilizada para validar se a região encontrada, de
