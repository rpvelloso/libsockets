...
três categorias: as que utilizam o texto da página, as que utilizam a
...
\#11), não atendem a todos os requisitos que o método proposto atende (Linha
\#14). Por exemplo: os métodos que não dependem da sintaxe HTML, necessitam de
