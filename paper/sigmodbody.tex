...
% {\textcolor{red}{est√°s afirmando uma coisa que vais provar? Pelo menos uma
% justificativa dessa tua "cren√ßa" deve ser dada, afinal, est√°s criticando
% trabalhos relacionados e isso n√£o pode ser gratuitamente}}
...
% {\textcolor{red}{este par√°grafo est√° trazendo a discuss√£o de n√£o
% estruturado, semi-est. e estruturado. Mas isso deve aparecer antes, l√° no
% par√°grafo da motiva√ß√£o... at√© aqui, n√£o est√° claro o que tu vais
% consideradar... o t√≠tulo fala em "detectar conte√∫do estruturado", mas a tua
% fonte vai ser como? n√£o estruturado, semi-est. e estruturado? n√£o est√°
% claro}%}

% {\textcolor{red}{os desafios de resolver o problema n√£o v√£o ser
% discutidos?"How can we distinguish between noise and useful content?" Algu√©m
% pode achar que √© f√°cil :-) conven√ßa-os de que n√£o √© :-)}%}

% {\textcolor{red}{eu acho que √© necess√°rio uma motiva√ß√£o para o uso destas
% t√©cnicas de ML... da mesma forma que aquele revisor (do email que te mandei)
% comentou, algu√©m pode dizer que "est√£o simplesmente testando um monte de
% t√©cnica de ML em cima de um problema"... "qual √© o tcham do neg√≥cio?"}%}

% proposed approach
\textcolor{red}{eu acho que aqui neste par·grafo deveria deixar mais explÌcito, tecnicamente, do que se trata o trabalho publicado no CIKM. N„o precisa explicar, mas mostrar a intuÌÁ‡o do uso de processamento de sinais; afinal, todas as tuas features foram extraÌdas considerando a ideia que est· l·... e isso n„o est· dito em lugar algum}
...
% que foi feito pelos autores, n√©? :-) "... its source code is freely
% available". Acho que d√° para ser mais direto e colocar apenas que as
% justificativas t√©cnicas e fim de papo}}
...
% {\textcolor{red}{DOM tree?? como assim, de onde saiu? N√£o fale em DOM tree na
% introdu√ß√£o, se est√°s em um n√≠vel de abstra√ß√£o maior... aqui, por
% enquanto, √© tudo HTML documents}}
...
\textcolor{red}{n„o vais explicar a intuiÁ„o de como as features s„o extraÌdas? Afinal, teu documento È representado como um sinal e todas as features s„o extraÌdas com base em valores detectados neste sinal; n„o È isso? Deve ficar claro isso aqui. Outra coisa, tem bastante espaÁo sobrando... acho que poderias fazer uma figura similar ‡quela que tem no CIKM com a p·gina original e o que foi gerado dela (n„o a mesma, por favor!)}
...
\textcolor{red}{a Figura 5 est· bem mal explicada... :( sei que est·s referenciando o artigo do CIKM, mas pelo menos explique o que significa. A figura em si tem duas imagens, e quando falas por exemplo que o n˙mero de registro È 20, o leitor fica confuso se isso deve ser visto na primeira imagem ou na segunda. Coloque (a) e (b) em cada uma delas e explique melhor o que elas representam. AlÈm disso, claro ela foi gerada a partir de que outra imagem? (na verdade, a primeira imagem È um "corte" de uma regi„o e isso n„o est· claro}
...
% bem direta e faria um par√°grafo que apresente, em uma frase, o(s) objetivo(s)
% dos experimentos (cujos resultados ser√£o apresentados pelas metricas de
% avaliacao com numero plotados nos gr√°ficos)}%}
...
% \textcolor{red}{as legendas das figuras estao iguais... al√©m disso, eu
% colocaria a legenda de noise e content mais visivel (est√° escondida, eu
% demorei para achar ...:) ) }
 
\textcolor{red}{esta tabela poderia ter a quantidade de documentos estruturados e a quantidade de documentos n„o estruturados, j· que trata de um resumo sobre o dataset} 
\begin{table}[h]
\centering
...
\begin{figure}[h]
  ...
  \caption{Input dataset features: content vs noise. \textcolor{red}{esta figura fica boa quando imprime? Ser· que n„o seria melhor colocar sÛ 2 lado a lado? N„o esqueÁa de rotular direito as coordenadas - d· uma onferida em todas as tuas figuras antes de submeter e veja se est„o bem explicadas}}
  \label{fig:dataset}
\end{figure}
...
results published in \cite{TPC09}, using the same dataset. The work in
\cite{TPC09} deals specifically with structured content, the authors have not
measure its performance in the presence of noise as we did in Table
\ref{tab:resultnoise}.
