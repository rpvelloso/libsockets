...
\begin{description}
\item[Algorithm \ref{alg:tree2seq} description] Procedure
...
``'', ``'')}. In Line \ref{lin:alg:tree2seq:a} the current tag path string is
...
\State $diff \leftarrow difference(contour)$
...
is required. Our approach also has some interesting byproduct, the structure
