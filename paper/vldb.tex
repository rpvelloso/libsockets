...
Our implementation is publicly available at \cite{} and we encourage and support the
...
Again we've performed slightly worst, but close to a perfect result.
...
implementation. We can see that the graph suggests a linear increase in the
running time to process a document end-to-end.
...
- conclusoes
	- resumo da conclusao
	- onde falha
	- onde eh possivel melhorar
	- problema para comparar tb prejudica pesquisa
- trabalhos futuros highlight some possiblities
	- alinhamento
	- dataset padrao sampleado do indice
	- reduzir complexidade com algoritmo de goertzel
	- lempel-ziv
	- ambiente c++/lua, melhorar para servir de suporte para pesquisas futuras,
	evitar retrabalho, facilitar implementacao e comparacao, fornecer
	infraestrutura
