...
have a significant impact in run time because it is proportional to the number
...
\begin{lstlisting}[language={[5.2]Lua}, caption={Lua source code calling C++ exposed interface.}]
