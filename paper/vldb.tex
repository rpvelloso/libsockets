...
% - melhorar a crÌtica sobre a falta de implementacoes: nao permitem analise
...
Roberto Panerai Velloso\\
       ...
       \affaddr{Florian√≥polis (SC), Brazil}\\
...
organizing semantically related entities in order to facilitate document
comprehension by a human user. This semi-structured data, although varied in
layout and domain, has common characteristics that can be used to identify it
inside a document and improve its structure to the point where it is possible to
access it as relational data (i.e., as structured data).
...
independent (i.e., we have no heuristic rules targeted at specific tags). The
sequence representation enables the use of signal processing techniques. We
segment the sequence into its cyclic subsequences (which represent structured
data regions) using the finite difference (Definition \ref{def:diff}) and within
each of this cyclic subsequences we find their main period (which represents the
size of the records) and frequency (which represents the number of records within that data
region) using its spectrum (Definition \ref{def:fft}) and we use this
information (record size and record count) to break down the data region into records.
...
techniques\cite{RRunner01,fivatech2010,clustVX2014,datapath2015}, others
...
it\cite{vips03,viper05,depta05,vide10,clustVX2014}.
...
specifically, because it is a \textbf{standardized} measure of dispersion.
...
We use it here to convert the PSD of all structured regions to a common ground,
so they can be validated against the same thresold. This is needed because each
...
seen so far in the sequence. It can be tought of as the \textit{skyline} of the
sequence.
The contour is important, in our context, because it is flat throughout a
structured region as illustrated in Figure \ref{fig:contour}a. Function \texttt{contour} of algorithm
\ref{alg:idreg} (Lines
...
is zero and consider them to be candidate data regions that are submited to
...
\section{Structured Data Extraction}\label{sec:prop}
...
\begin{figure}[h]
  \centering
     \includegraphics[width=\columnwidth]{img/proposal.jpg}
...
what was done in \cite{clustVX2014} with the difference that here we use class
...
that calls the other subrotines. It receives a TPS as input and returns the
...
\ref{fig:stru}). Figure \ref{fig:fftreg}a shows the subsequence that represents
a structured region of the TPS and, hence, displays a cyclic behaviour and a
linear regression with a small angle; Figure \ref{fig:fftreg}b shows the
subsequence's PSD with a highlighted frequency peak. This frequency peak
represents the record count (or number of cycles in the subsequence) and the
corresponding period (i.e., the subsequence length divided by the frequency) is
equivalent to the records mean size.
...
order, using the coefficient of variation (CV for short) of the distance between
its occurrences, e.g., if a given tag path occurs at positions \{10, 20, 30\},
the distances between consecutive occurrences are \{$20-10 = \textbf{10}$,
$30-20 = \textbf{10}$\} and the CV is equal to 0.0\% since all distances are the
same. In order to determine if a tag path is well distributed a threshold must
be set. Since the regions are cyclic, the number of different tag paths that
form the region's sequence is much smaller when compared to the size of the
sequence. This is due to inherent repetitions and so it is not prohibitive to
check the CV of every symbol in the region's alphabet.
...
Once the records are identified they need to be properly aligned (i.e., their
...
error bound. This algorithm makes no assumptions about the data being aligned
(i.e., it is general) and runs in time proportional to $O(k^2n^2)$, where $k$ is
the number of records to be aligned and $n$ is the size of the records. The
alignment score for the approximate solution is guaranteed to be at most a factor
of 2 worst than the optimal solution's score and in practice can be better than
this for similar strings, according to \cite{centerstar1993}.
...
\ref{fig:fftreg}a. The values are TPCodes, each representing a distinct node in
the DOM tree.
...
when evaluating the goodness of an alignment.
...
rec \#&\multicolumn{15}{c|}{fields (TPCodes)}\\ \hline
 \#1&252&256&258&259&262&266&270&272&270&270&274&   &   &   &278\\ \hline
 \#2&252&256&258&259&262&266&270&272&270&270&   &280&   &274&278\\ \hline
 \#3&252&256&258&259&262&266&270&272&270&270&274&280&274&   &   \\ \hline
 \#4&252&256&258&259&262&266&270&272&270&270&274&280&   &274&278\\ \hline
 \#5&252&256&258&259&262&266&270&272&270&270&274&280&   &274&   \\ \hline
 \#6&252&256&258&259&262&266&270&272&270&270&274&280&   &274&278\\ \hline
 \#7&252&256&258&259&262&266&270&272&270&270&274&   &   &   &   \\ \hline
 \#8&252&256&258&259&262&266&270&272&270&270&274&280&   &274&278\\ \hline
 \#9&252&256&258&259&262&266&270&272&270&270&   &280&   &274&   \\ \hline
\#10&252&256&258&259&262&266&270&272&270&270&274&280&   &274&   \\ \hline
\#11&252&256&258&259&262&266&270&272&270&270&274&   &   &   &278\\ \hline
\#12&252&256&258&259&262&266&270&272&270&270&274&   &   &   &278\\ \hline
\#13&252&256&258&259&262&266&270&272&270&270&274&   &   &   &   \\ \hline
\#14&252&256&258&259&262&266&270&272&270&270&   &280&   &274&   \\ \hline
\#15&252&256&258&259&262&266&270&272&270&270&274&280&   &274&   \\ \hline
\#16&252&256&258&259&262&266&270&272&270&270&274&   &   &   &   \\ \hline
\#17&252&256&258&259&262&266&270&272&270&270&274&280&   &274&   \\ \hline
\#18&252&256&258&259&262&266&270&272&270&270&274&280&   &274&278\\ \hline
\#19&252&256&258&259&262&266&270&272&270&270&274&280&274&278&278\\ \hline
\#20&252&256&258&259&262&266&270&272&270&270&274&280&274&   &   \\ \hline
\end{tabular}
\end{tiny}%}
\end{table}
...
degrades the quality of the extraction.
...
implementation. We can see that the graph suggests a $O(n\cdot log(n))$ time
