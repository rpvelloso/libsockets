...
Figure \ref{fig:contour}a. In Figure \ref{fig:contour}b we show the subsequences
where the finite difference of the contour is zero-valued (i.e., the intervals
where the sequence stabilizes).
