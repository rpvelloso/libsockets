...
parser) is marginal, only 1.22\% larger, and the achieved results are the same
(precision, recall and F-Score) as shown in Tables \ref{table:compare3} and
...
6.61\% (in dataset \#1) and 2.13\% (in dataset \#2) over our approach. Put
