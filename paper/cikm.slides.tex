...
\begin{itemize}
\item The region's score is directly proportional to its size and
inversely proportional to its distance from the center of the sequence;
...
Results using our own dataset with $1466$ records from $46$ different websites
in various domains.
