...
\begin{enumerate}
\item \textbf{Segmantation}: diferentes
...
\item \textbf{Records}: regiões com conteúdo semiestruturado são compostas
por conjuntos de registros contíguos e com estrutura semelhantes, 
...
\frame{\frametitle{Contour difference}
\begin{figure}[H]
