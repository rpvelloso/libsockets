...
páginas \textit{web} que utiliza, como representação do documento HTML, a seqüência de
\textit{tag paths} da árvore DOM. Conforme a análise apresentada na Seção
...
da proposta deste trabalho são as seguintes:
