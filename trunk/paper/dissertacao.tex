...
\titulo{Segmentação e Remoção Automática de Ruído de Páginas $web$ Utilizando $tag$ $paths$}
...
discutidos e tratados na Seção \ref{sec:disc}, e, apesar desta redução, as
...
2. Itemize um conjunto de tarefas que seriam trabalhos futuros

3. Acrescente contribuições importantes do trabalho, como publicações,
implementação (ou melhoria) de código...  comente sobre cada contribuição
